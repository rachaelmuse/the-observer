...
SEED: list[tuple[str, str, str]] = [
    ...
    ("epistemic_integrity", RegistryStatus.CONNECTED.value, "claim gates + inquiry frame: who/what/when/where; how/why stay possible"),
    ("source_universe", RegistryStatus.CONNECTED.value, "source classes/networks exist; news is not a whitelist"),
    ("freenet_adapter", RegistryStatus.UNAVAILABLE.value, "Freenet is a source-network type; live retrieve not seated"),
    ("i2p_adapter", RegistryStatus.UNAVAILABLE.value, "I2P is a source-network type; live retrieve not seated"),
    ("tor_public_adapter", RegistryStatus.UNAVAILABLE.value, "Tor public services are a source-network type; live retrieve not seated"),
    ("ipfs_adapter", RegistryStatus.UNAVAILABLE.value, "IPFS/public decentralized retrieve not seated"),
